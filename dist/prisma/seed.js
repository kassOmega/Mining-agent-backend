...
async function main() {
    ...
    await prisma.mineralType.deleteMany();
    ...
    if (asosaKebele01) {
        await prisma.site.create({
            data: {
                ...
                title: "Abebe Bekele",
                description: "Rich alluvial gold deposit near the river bank. Easily accessible by road.",
    ...
    if (sherkoleKebele02) {
        await prisma.site.create({
            data: {
                ...
                title: "Tadesse Hailu",
                description: "Hard rock gold vein exposed on hillside. Requires drilling equipment.",
    ...
    if (dangurKebele01) {
        await prisma.site.create({
            data: {
                ...
                title: "Hassan Omar",
                description: "Newly discovered site. Initial tests show high tantalum traces.",
