...
export class NotificationsService {
  ...
  // Notify moderators when new post is created
  async notifyModeratorsNewPost(site: any) {
  ...
  // Notify site owner when site is verified
  async notifySiteVerified(email: string, siteTitle: string) {
  ...
  // Notify site owner when site is rejected
  async notifySiteRejected(email: string, siteTitle: string, reason: string) {
  ...
  // Notify subscribers when new site is verified
  async notifySubscribersNewSite(site: any) {
  ...
  // ==========================================
  // SUBSCRIPTION EXPIRY WARNING (5 Days)
  // ==========================================
